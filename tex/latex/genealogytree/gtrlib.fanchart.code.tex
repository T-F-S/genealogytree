...
\cs_new:Npn \__getree_fanchart_segment_computation:
  {
    ...
    \use:x
      {
        \exp_not:N\pgfkeys{/gtr/level~0/.append~code={\exp_not:N\pgfkeysalso{node~size=\l__getree_tmpa_tl,level~size=\l__getree_tmpa_tl}}}
      }
    \int_step_inline:nnn {1} { \c_getree_fanchart_maximum_rings_tl-1 }
      {
        ...
        \fp_set:Nn \l__getree_tmpa_fp { sqrt( 1 - ( ( \l__getree_fanchart_radius_fp+\l_tmpb_fp )/4 )^2 ) }

        \fp_compare:nNnTF { \l__getree_fanchart_angle_fp<90 ? \l__getree_fanchart_radius_fp*tand(\l__getree_fanchart_angle_fp)<\l__getree_tmpa_fp : 0 } = {0}
          {
            \tl_set:Nx \l__getree_tmpa_tl {\fp_to_dim:n{ 2*\l__getree_tmpa_fp*\l__getree_fanchart_outer_off_fp }}%  b
          ...
          {
            \fp_set:Nn \l__getree_tmpa_fp { sqrt( 1 - ( \l__getree_fanchart_radius_fp*tand(\l__getree_fanchart_angle_fp) )^2 ) }
            \fp_set:Nn \l_tmpb_fp { cosd( \l__getree_fanchart_angle_fp/2 ) }
            \fp_compare:nNnTF {\l__getree_tmpa_fp} < {\l_tmpb_fp}
              {
                \tl_set:Nx \l__getree_tmpa_tl {\fp_to_dim:n{ 2*\l__getree_fanchart_radius_fp*tand(\l__getree_fanchart_angle_fp)*\l__getree_fanchart_outer_off_fp }}%  b
                \tl_set:Nx \l_tmpb_tl {\fp_to_dim:n{ (\l__getree_tmpa_fp-\l__getree_fanchart_radius_fp)*\l__getree_fanchart_outer_off_fp }}%  h
                \fparray_gset:Nnn \g__getree_fanchart_distances_fparry { ##1 }{ (\l__getree_tmpa_fp+\l__getree_fanchart_radius_fp)/2*\l__getree_fanchart_outer_off_fp }
              }
              {
                \tl_set:Nx \l__getree_tmpa_tl {\fp_to_dim:n{ 2*sind(\l__getree_fanchart_angle_fp/2)*\l__getree_fanchart_outer_off_fp }}%  b
        ...
        \int_compare:nNnTF {##1} < {\l__getree_fanchart_landscape_level_tl}
          {
            \use:x
            {
              \exp_not:N\pgfkeys{/gtr/level~##1/.append~code={\exp_not:N\pgfkeysalso{node~size=\l__getree_tmpa_tl,level~size=\l_tmpb_tl}}}
            }
          }
          {
            \use:x
            {
              \exp_not:N\pgfkeys{/gtr/level~##1/.append~code={\exp_not:N\pgfkeysalso{node~size=\l_tmpb_tl,level~size=\l__getree_tmpa_tl}}}
            }
          }
    ...
    \int_compare:nNnTF {\l_getree_fanchart_level_tl} > {0}
      {
        ...
        \fp_set:Nn \l__getree_tmpa_fp { \fparray_item:Nn\g__getree_fanchart_radii_fparry{#2+1} }
          ...
          \cs_if_exist:cTF {gtr@per@##1@chiof}
            {
              \tl_put_right:Nx\l__getree_fanchart_recursive_action_tl
                {
                  \exp_not:N\__getree_fanchart_draw_family:nnnn { \use:c{gtr@per@##1@chiof} }{ \int_eval:n{#2+1} }{ #3 }{ \l__getree_tmpa_tl }
                }
            }
            {
              \tl_put_right:Nx\l__getree_fanchart_recursive_action_tl
          ...
          \cs_if_exist:cTF {gtr@per@##1@chiof}
            {
              \tl_put_right:Nx\l__getree_fanchart_recursive_action_tl
                {
                  \exp_not:N\__getree_fanchart_draw_family:nnnn { \use:c{gtr@per@##1@chiof} }{ \int_eval:n{#2+1} }{ \l__getree_tmpa_tl }{ #4 }
                }
            }
            {
              \tl_put_right:Nx\l__getree_fanchart_recursive_action_tl
...
\cs_new:Npn \__getree_fanchart_paper_fit:nn #1#2
  {
    ...
    \fp_compare:nTF { \l__getree_tmpa_fp > \l_tmpb_fp }
      {
        \fp_compare:nTF { \l_tmpb_fp > \l__getree_tmpa_fp/2 }
          {
            \fp_set:Nn \l__getree_tmpa_fp { 180+2*asind( 2*\l_tmpb_fp/\l__getree_tmpa_fp - 1 ) }
            \gtrset
              {
      ...
      {
        \fp_compare:nTF { \l__getree_tmpa_fp > \l_tmpb_fp/2 }
          {
            \fp_set:Nn \l__getree_tmpa_fp { 180+2*asind( 2*\l__getree_tmpa_fp/\l_tmpb_fp -1 ) }
            \gtrset
              {
...
\gtrset{
  fanchart~radii/.code={
    \clist_set:Nn \l__getree_tmpa_clist {#1}
    \fparray_gzero:N \g__getree_fanchart_radii_fparry
    \int_zero:N \l__getree_tmpa_int
    \fp_zero:N \l_tmpb_fp
    \clist_map_inline:Nn \l__getree_tmpa_clist
      {
        \int_incr:N \l__getree_tmpa_int
        \fp_set:Nn \l__getree_tmpa_fp { ##1 }
        \fp_add:Nn \l_tmpb_fp {\l__getree_tmpa_fp}
        \fparray_gset:Nnn \g__getree_fanchart_radii_fparry { \l__getree_tmpa_int }{ \l_tmpb_fp }
      }
    ...
    \clist_map_inline:Nn \l__getree_tmpa_clist
      {
        \int_incr:N \l__getree_tmpa_int
        \fp_set:Nn \l__getree_tmpa_fp { ##1 }
        \fparray_gset:Nnn \g__getree_fanchart_inner_fparry { \l__getree_tmpa_int }{ \l__getree_tmpa_fp }
      }
    \int_step_inline:nnn { \l__getree_tmpa_int+1 }{ \c_getree_fanchart_maximum_rings_tl }
      {
        \fp_add:Nn \l_tmpb_fp {\l__getree_tmpa_fp}
        \fparray_gset:Nnn \g__getree_fanchart_inner_fparry { ##1 }{ \l__getree_tmpa_fp }
      }
  },
    ...
    \clist_map_inline:Nn \l__getree_tmpa_clist
      {
        \int_incr:N \l__getree_tmpa_int
        \fp_set:Nn \l__getree_tmpa_fp { ##1 }
        \fparray_gset:Nnn \g__getree_fanchart_outer_fparry { \l__getree_tmpa_int }{ \l__getree_tmpa_fp }
      }
    \int_step_inline:nnn { \l__getree_tmpa_int+1 }{ \c_getree_fanchart_maximum_rings_tl }
      {
        \fp_add:Nn \l_tmpb_fp {\l__getree_tmpa_fp}
        \fparray_gset:Nnn \g__getree_fanchart_outer_fparry { ##1 }{ \l__getree_tmpa_fp }
      }
  },
