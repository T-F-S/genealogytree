...
\cs_new_protected:Npn \getree_set_options_for_subtree:nn #1#2
  {
...
\cs_new_protected:Npn \getree_set_options_for_family:nn #1#2
  {
    \clist_set:Nn \l__getree_tmpa_clist { #1 }
    \clist_map_inline:Nn \l__getree_tmpa_clist
      {
...
\cs_new_protected:Npn \getree_set_options_for_node:nn #1#2
  {
    \clist_set:Nn \l__getree_tmpa_clist { #1 }
    \clist_map_inline:Nn \l__getree_tmpa_clist
      {
...
\gtrset{%
  ...
  insert for childless families level limit/.store in=\gtr@childlesschild@levellimit,
  insert for childless families/.code={%
    \ifblank{#1}%
      {\def\gtr@parse@childlesschild@hook{}}%
      {\long\def\gtr@parse@childlesschild@hook{%
        \ifnum\gtr@c@level>\gtr@childlesschild@levellimit\relax%
          \ifcsundef{gtr@fam@\gtr@currentfamily @patchi}{\gtr@parse@graph #1x}{}%
        \fi%
      }}%
  },
  ...
  ignore parent childs/.code={\let\gtr@parent@@c\gtr@parent@@c@ignore},
  %
  ...
  autofill parents male female*/.code={%
    \def\gtr@complementparents@levellimit{#1}%
    \let\gtr@parse@complementparents@hook\gtr@parse@complementparents@malefemale%
    \let\gtr@parent@@p\gtr@parent@@p@malefemale%
  },
  ...
  autofill parents female male*/.code={%
    \def\gtr@complementparents@levellimit{#1}%
    \let\gtr@parse@complementparents@hook\gtr@parse@complementparents@femalemale%
    \let\gtr@parent@@p\gtr@parent@@p@femalemale%
  },
  ...
  autofill parents unspecific*/.code={%
    \def\gtr@complementparents@levellimit{#1}%
    \let\gtr@parse@complementparents@hook\gtr@parse@complementparents@unspecific%
  ...
  autofill parents none/.code={%
    \def\gtr@parse@complementparents@hook{}%
    \let\gtr@parent@@p\gtr@parent@@p@normal%
  },
}
