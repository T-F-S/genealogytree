%% The LaTeX package genealogytree - version 1.11pre1 (2017/03/03)
...
%%
\gtr@set@library@version{1.11pre1}
...
\def\gtr@list@event@floruit{%
  \gtrifeventdefined{floruit}{\gtrlistseparator\gtrPrintEvent{floruit}}{%
  }%
}
