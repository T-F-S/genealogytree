...
\gtrset{%
  ...
  id/.code={\gtrset{id=#1,code={\gtr@key@keysalsofrom{/gtr/nopt/\gtr@gkv@id}}}},
}
...
\def\gtrifnativitydefined#1#2{%
  \gtrifeventdefined{birth}{#1}{%
    \gtrifeventdefined{baptism}{#1}{#2}%
  }%
}

\def\gtrifwedlockdefined#1#2{%
...
\def\gtrifdeceasedefined#1#2{%
  \gtrifeventdefined{death}{#1}{%
    \gtrifeventdefined{burial}{#1}{#2}%
  }%
}
...
\gtrDeclareDatabaseFormat{medium marriage above}{}{%
  \gtrifwedlockdefined{\begin{gtreventlist}\gtr@list@event@marriage\end{gtreventlist}\tcbline}{}%
  \gtrPrintName%
  \begin{gtreventlist}%
    \gtr@list@event@birth%
    \gtr@list@event@floruit%
...
\gtrDeclareDatabaseFormat{medium marriage below}{}{%
  ...
  \end{gtreventlist}%
  \gtr@print@infolist%
  \gtrifwedlockdefined{\tcbline\begin{gtreventlist}\gtr@list@event@marriage\end{gtreventlist}}{}%
}
...
\tikzset
  {
    fill@gtrDB@image@options/.code=
      {
        \tl_set:Nx \l__getree_tmpa_tl { fill~image~options = { \exp_not:V \gtrDBimageopt } }
        \pgfkeysalsofrom { \l__getree_tmpa_tl }
      }
  }
...
\gtrset{%
  ...
  date range before/.code n args={2}{\def\gtrkv@range@before@A{#1}\def\gtrkv@range@before@B{#2}},
  date range after/.code n args={2}{\def\gtrkv@range@after@A{#1}\def\gtrkv@range@after@B{#2}},
  date range separator/.style={date range full={}{#1}{},date range before={#1}{},date range after={}{#1}},
  date range separator/.default={--},
  place text/.code n args={2}{\def\gtrkv@place@pre{#1}\def\gtrkv@place@app{#2}},
